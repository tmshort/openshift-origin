...
var Annotations = map[string]string{
	...
	"[sig-olmv1] OLMv1 operator installation should create a catalog": " [Suite:openshift/conformance/parallel]",

	"[sig-olmv1] OLMv1 should be installed with clustercatalogs at version v1alpha1 [apigroup:olm.operatorframework.io]": " [Suite:openshift/conformance/parallel]",

	"[sig-olmv1] OLMv1 should be installed with clusterextensions at version v1alpha1 [apigroup:olm.operatorframework.io]": " [Suite:openshift/conformance/parallel]",

	"[sig-olmv1] OLMv1 should have access to certain files checks the manager containers for those files": " [Suite:openshift/conformance/parallel]",
